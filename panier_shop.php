                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-remove">
                                                <a title="Remove this item" class="remove" href="panier_shop.php?delPanier=<?= $produit->id; ?>">×</a>
                                            </td>

                                            <td class="product-thumbnail">
                                                <img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="img/produit-<?= $produit->id ?>.png">
                                            </td>
